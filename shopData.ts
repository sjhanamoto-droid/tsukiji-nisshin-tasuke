...
export const SHOP_DETAILS: Record<string, ShopDetail> = {
  tsukiji: {
    ...
    heroImage: assetUrl('/images/backgrounds/bg.jpg'),
    description: [
    ...
    menuHighlights: [
      {
        ...
        image: assetUrl('/images/menu/aoi.jpg'),
      },
      {
        name: '築地うな重『白蒲葵』',
        price: '¥2,380',
        description: '蒲焼と白焼きを一度にお楽しみいただける人気No.1の葵弁当。粒ゆず胡椒で頂くうなぎはまさに絶品。',
        image: assetUrl('/images/menu/shirokabaaoi.jpg'),
      },
      {
        name: '築地うな重『王』',
        price: '¥3,480',
        description: '大ぶりなうなぎを丸々一尾盛り付けた最高級うな重。テレビでもたびたび紹介される贅沢な逸品。',
        image: assetUrl('/images/menu/ou.jpg'),
      },
    ],
    gallery: [
      assetUrl('/images/backgrounds/bg.jpg'),
    ],
  ...
  kaminoge: {
    ...
    heroImage: assetUrl('/images/kinunagi/main.jpg'),
    description: [
    ...
    menuHighlights: [
      {
        ...
        image: assetUrl('/images/menu/gokujo.webp'),
      },
      {
        name: '金のうな重【大王】',
        price: '',
        description: 'うなぎの下にもう一切れ隠された、ボリューム満点の特別なうな重。食べ応え抜群。',
        image: assetUrl('/images/menu/daiou.webp'),
      },
      {
        name: '極みのひつまぶし【極上】',
        price: '',
        description: '名古屋スタイルのひつまぶし。そのまま・薬味で・出汁で——三つの味わいをお楽しみください。',
        image: assetUrl('/images/menu/hitsumabushi.webp'),
      },
      {
        name: '築地のうなぎ飯',
        price: '',
        description: 'ランチに人気のお手軽メニュー。リーズナブルに本格うなぎを堪能できます。',
        image: assetUrl('/images/menu/unagimeshi.webp'),
      },
    ],
    gallery: [
      assetUrl('/images/kinunagi/main.jpg'),
      assetUrl('/images/kinunagi/shop1.jpg'),
      assetUrl('/images/kinunagi/unagi-king.jpg'),
      assetUrl('/images/kinunagi/hitumabusi.jpg'),
      assetUrl('/images/kinunagi/shirokabayaki.jpg'),
    ],
  ...
  nakamurabashi: {
    ...
    tel: '03-5848-6671',
    hours: '平日 11:00〜15:00 / 17:00〜20:00、土日祝 11:00〜20:00',
    heroImage: assetUrl('/images/kinunagi/shop2.jpg'),
    description: [
    ...
    gallery: [
      assetUrl('/images/kinunagi/shop2.jpg'),
      assetUrl('/images/kinunagi/unagi-king.jpg'),
      assetUrl('/images/kinunagi/shirokabayaki.jpg'),
    ],
