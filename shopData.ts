    ...
    menuHighlights: [
      {
        ...
        image: assetUrl('/images/menu/gokujo.png'),
      },
      {
        name: '金のうな重【大王】',
        price: '',
        description: 'うなぎの下にもう一切れ隠された、ボリューム満点の特別なうな重。食べ応え抜群。',
        image: assetUrl('/images/menu/daiou.png'),
      },
      {
        name: '極みのひつまぶし【極上】',
        price: '',
        description: '名古屋スタイルのひつまぶし。そのまま・薬味で・出汁で——三つの味わいをお楽しみください。',
        image: assetUrl('/images/menu/hitsumabushi.png'),
      },
      {
        name: '築地のうなぎ飯',
        price: '',
        description: 'ランチに人気のお手軽メニュー。リーズナブルに本格うなぎを堪能できます。',
        image: assetUrl('/images/menu/unagimeshi.png'),
      },
    ],
    gallery: [
